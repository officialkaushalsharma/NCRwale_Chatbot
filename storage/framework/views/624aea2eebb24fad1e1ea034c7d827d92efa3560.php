        ...
        <div class="chatbot row">
            ...
            <div class="msg-body">
                ...
                <div class="first-menu col-12 my-3">
                    ...
                    <ul id="menu-list">
                        <li class="bg-1">
                            <a href="<?php echo e(url('/aadhaarService')); ?>" class="service" data-text="Aadhaar-Services">
                    ...
                    <ul>
                        <li class="bg-3">
                            <a href="<?php echo e(url('/updateAadhaar')); ?>" class="service" data-text="Update-Aadhaar">
                        ...
                        <li class="bg-4">
                            <a href="<?php echo e(url('/bookAppointment')); ?>" class="service" data-text="Book-Appointment">
...
</html><?php /**PATH C:\Users\91783\Downloads\vikrant\ray-of-identity\resources\views/main/main-page.blade.php ENDPATH**/ ?>